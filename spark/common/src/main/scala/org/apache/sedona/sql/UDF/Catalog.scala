...
object Catalog {
  ...
  val expressions: Seq[FunctionDescription] = Seq(
    ...
    function[ST_CoveredBy_Private](),
    function[ST_Within_Private](),
    function[ST_Overlaps_Private](),
    function[ST_Crosses_Private](),
    function[ST_Touches_Private](),
    function[ST_Equals_Private](),
